...
$fetch = mysqli_query($db, "SELECT * FROM subscribers ORDER BY subs_id DESC");
...
<head>
    ...
    <title>Subscribers | Asopalav.in</title>
...
<body>
    ...
    <main class="flex-1 p-4 overflow-y-auto bg-gradient-to-br from-[#ae8dfc3b] via-purple-50 to-[#ae8dfc36]">
        ...
        <h2 class="text-2xl font-semibold text-[#512DA8] mb-4">Subscribers : </h2>
            ...
            <table class="min-w-full border border-gray-300 text-left text-sm text-gray-700 rounded-md overflow-hidden shadow-md shadow-gray-500">
                <thead class="bg-[#c7a8f57e] text-[#512DA8] uppercase font-semibold tracking-wider">
                    <tr class="border border-gray-300">
                        ...
                        <th class="w-[95%] px-3 py-2 border border-gray-300">Subscriber's Email</th>
                    </tr>
                </thead>
        ...
        <?php } else {
            echo "<p class='text-gray-600'>No Subscribers found.</p>";
        } ?>
    </main>
