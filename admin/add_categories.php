...
if (isset($_REQUEST['submit_btn'])) {
    ...
    mysqli_query($db, "INSERT INTO category (category_name, category_image) VALUES ('$name', '$image')");
...
<head>
    ...
    <title>Add Category | Asopalav.in</title>
...
<body>
    ...
    <main class="flex-1 p-4 overflow-y-auto bg-gradient-to-br from-[#ae8dfc3b] via-purple-50 to-[#ae8dfc36]">
        <h2 class="text-2xl font-semibold text-[#512DA8] mb-4">Add Category :</h2>
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" id="category_name" name="category_name" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#512DA8]" placeholder="category name..." />
            </div>
